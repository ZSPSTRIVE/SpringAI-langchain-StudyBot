  ...
  function markStatic$1 (node) {
    ...
    if (node.type === 1) {
      ...
      if (node.ifConditions) {
        let i$1 = 1;
        const l$1 = node.ifConditions.length;
        for (; i$1 < l$1; i$1++) {
