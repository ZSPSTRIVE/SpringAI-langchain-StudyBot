...
const uploadUrl = computed(() => {
  ...
  return baseUrl ? `${baseUrl}/api/v1/upload/image` : '/api/v1/upload/image'
})
...
const handleSuccess = (response) => {
  ...
  // 处理不同的响应格式
  if ((response.success && response.data) || (response.code === 200 && response.data)) {
